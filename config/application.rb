...
module Greenlight
  class Application < Rails::Application
    ...
    config.bigbluebutton_endpoint_axios = ENV["bigbluebutton_endpoint_axios"]
    ...
    config.allow_user_signup = (ENV['ALLOW_GREENLIGHT_ACCOUNTS'] == "true") || 'true'
    ...
    config.report_issue_url = ENV["REPORT_ISSUE_URL"] || "https://www.inet.co.th/"
    config.help_url = ENV["HELP_URL"].presence || "https://www.inet.co.th/"

    # DEFAULTS

    # Default branding image if the user does not specify one
    config.branding_image_default = "https://www.inet.co.th/assets/img/newlogo.png"

    # Default primary color if the user does not specify one
    config.primary_color_default = "#49AF44"

    # Default primary color lighten if the user does not specify one
    config.primary_color_lighten_default = "#D3EDD2"

    # Default primary color darken if the user does not specify one
    config.primary_color_darken_default = "#49AF44"
