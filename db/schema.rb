...
ActiveRecord::Schema.define(version: 2020_04_24_040547) do

  # create_table "codeids", force: :cascade do |t|
  ...
  create_table "sessionotp", force: :cascade do |t|
    t.string "email"
    t.string "otp"
  end

  create_table "useroneids", force: :cascade do |t|
    t.string "oneid"
    t.string "email"
    t.string "mainfolder"
    t.string "recordfolder"
  end

  create_table "downloadrecord", force: :cascade do |t|
    t.string "fileid"
    t.string "oneid"
    t.string "meetingid"
    t.string "folderid"
  ...
  create_table "sessionbotrecord", force: :cascade do |t|
    t.string "botid"
    t.string "hostid"
  end
